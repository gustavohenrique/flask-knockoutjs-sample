...
(function (a) {
    a.extend(a.jqx._jqxGrid.prototype, {
        ...
        _geteditorvalue: function (d) {
            ...
            if (this.editcell.editor) {
                ...
                case "dropdownlist":
                    if (this.editcell.editor.jqxDropDownList) {
                        ...
                        if (e) {
                            f = e.originalItem instanceof Object ? e.originalItem : new String(e.label);
                        } else {
                            f = ""
                        }
                        if (f == null) {
            ...
            // by gustavohenrique
            if (this.editcell.hasOwnProperty('value') && "function" == typeof(this.editcell.value)) {
                this.editcell.value(f);
                return this.editcell.value;
            }
            return f;
        },
